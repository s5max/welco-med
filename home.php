                        ...
                        <div class="container">
                            <div class="row smooth-scroll">
                                <div class="col-md-12 text-center pt-3 wow fadeIn" data-wow-delay="0.2s">
                                    ...
                                    <a href="#features" class="btn btn-primary btn-rounded bienvenue" data-offset="100">Bienvenue</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container mb-4">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 pt-1 pb-1 wow fadeIn" data-wow-delay="0.3s">
                        <!--About-->
                        <h5 class="title mb-1"><strong>ABOUT RESTAURANT</strong></h5>
                        ...
                        <div class="footer-socials">
                            ...
                            <!--Dribbble-->
                            <a type="button" class="btn-floating btn-small btn-primary"><i class="fa fa-dribbble"></i></a>
                            <!--Twitter-->
                    ...
                    <div class="col-xl-3 offset-xl-1 col-lg-4 col-md-6 pt-1 pb-1 wow fadeIn" data-wow-delay="0.3s">
                        <!--Search-->
                        <h5 class="title"><strong>Search something</strong></h5>  
                    ...
                    <div class="col-xl-3 offset-xl-1 col-lg-4 col-md-6 t-1 pb-1 wow fadeIn" data-wow-delay="0.3s">
                        ...
                        <!--Title-->
                        <h5 class="title mb-2"><strong>Opening hours</strong></h5>
