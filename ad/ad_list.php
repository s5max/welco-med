            ...
            <div class="card-container manual-flip">
                <div class="card">
                    <div class="front">
                        ...
                        <div class="content">
                            <div class="main">
                                <p class="text-center"><strong><?/*= $v['title']*/?></strong><br><?/*= $v['kind']*/?><strong><?= $v['type']?></strong><br>Date de publication : <br><?= $details['department']?><br><?= $details['city']?><br><?= $v['description']?></p>
                            </div>
